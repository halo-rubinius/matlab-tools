...
%**************************************************************************
% Recommend:
%   multigradient('preset', 'div.km.BuRd')      blue-gray-red
%   multigradient('preset', 'div.cb.BuRd.9')    blue-white-red
%   multigradient('preset', 'div.cb.BuYlRd.9')  blue-yellow-red
%   multigradient('preset', 'div.cb.GnYlRd.9')  green-yellow-red
%   multigradient('preset', 'div.lb.BuWhRd')    blue-white-red
%   multigradient('preset', 'div.lb.BuCyYlRd')  blue-cyan-yellow-red
%   multigradient('preset', 'seq.cb.OrRd.9')    orange-red
%**************************************************************************
%
...
switch preset
    ...
    case 'div.cb.GnYlRd.10' % 10-colour diverging GnYlRd, by Cynthia Brewer
        ...
        % colors set by libin
    case 'div.lb.BuWhRd'
        rgb = [0, 0, 1; 1, 1, 1; 1, 0, 0];
        interp = 'rgb';
    case 'div.lb.BuCyYlRd'
